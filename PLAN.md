...
- [~] **Layers, history, tool-options panels** — first slice done
  ...
  **Not yet re-verified on real hardware** — worth checking with
  VoiceOver whether both the Layers *and* History panels now read real
  content instead of empty regions.
