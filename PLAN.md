...
- [~] **Component gallery + golden-image tests per theme and density** —
  ...
  **Still genuinely open**: one fresh bless step (`command_palette`,
  now against the margin-corrected layout) waiting on Cahya; everything
  else this bullet's own earlier "still genuinely open" paragraph
  already named, unchanged.
