...
- [x] **Unified undo/redo** — done 2026-08-06, closing the "pixel-first,
  ...
  **Still `[~]` in spirit, even though this bullet is `[x]`**: a
  ...
  into one step; unifying stroke granularity with Move's), not
  reopened by this bullet.
