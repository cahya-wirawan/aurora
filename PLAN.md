...
- [~] **Window/event loop; create hidden → attach a11y adapter → show**
  ...
  **Human-verified on macOS, 2026-08-03 (Cahya, real hardware, real
  ...
  open" shape M1.2's own DX12/Metal/Vulkan bullet went through) — the
  window's actual visual content is still just the placeholder clear
  colour (correct and expected: docking/panels/canvas content is
  separate, still-open M1.8 work, not a gap in this bullet), and
